...
# read data
train = pd.read_csv("F:/consumer/predict-online-shoppers-purchasing-intention-main/data/Test.csv")
test = pd.read_csv("F:/consumer/predict-online-shoppers-purchasing-intention-main/data/Train.csv")
...
#json_col_path = "c:\\Users\\ajith\\Downloads\\predict-online-shoppers-purchasing-intention-main\\models\\columns.json"

with open("F:/consumer/predict-online-shoppers-purchasing-intention-main/models/columns.json", "r") as j:
    contents = json.loads(j.read())

#data = pd.read_json("c:\\Users\\ajith\\Downloads\\predict-online-shoppers-purchasing-intention-main\\models\\columns.json")
# Access the contents of the DataFrame
#contents = data.to_dict()
...
clf_path = "F:/consumer/predict-online-shoppers-purchasing-intention-main/models/rf_clf.joblib"

rf_clf = joblib.load(open(clf_path, "rb"))

permutation_importance = np.load("F:/consumer/predict-online-shoppers-purchasing-intention-main/models/permutation_imp.npy")
...
#app = dbc.Dash(__name__, external_stylesheets=[dbc.themes.MATERIA])
...
def predict_purchase_intension(
    ...
    model_path = "C:/Users/Abrar/OneDrive/Desktop/project/predict-online-shoppers-purchasing-intention-main/models/rf_rnd_search1.joblib"
...
def shap_waterfall_plot(
    ...
    model_path = "F:/consumer/predict-online-shoppers-purchasing-intention-main/models/rf_rnd_search1.joblib"
    model = joblib.load(open(model_path, "rb"))
